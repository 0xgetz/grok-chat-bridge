...
Generated by [`scripts/build_demo_assets.py`](scripts/build_demo_assets.py) with
ffmpeg. The [`build-demo-assets` workflow](.github/workflows/build-demo-assets.yml)
rebuilds and commits them automatically whenever the builder changes — or
regenerate locally:
